...
print("4) Join GRU Rewards")
print("5) Enter GRU Rewards ID")
print("6) View GRU Rewards")
print("7) Redeem in Shop")
...
def askForCommand():
    ...
    if command == "1":
        ...
        try:
            ...
            print("Join GRU Rewards to view your rewards!")
    elif command == "7":
        print("Enter item code to redeem:")
        print("1) NordVPN - 73% Discount (50 reward points)")
        command = input("> ")
        if command == "1":
            x = str(base64.b64decode("aHR0cHM6Ly9iaXQubHkvNGZIVTVkVw=="))
            x = x.split("b'")[1]
            x = x.split("'")[0]
            with open("resources/cache.txt", "rb") as cache:
                reward_count = str(cache.read())
                ...
                reward_count = reward_count.split("'")[0]
                if reward_count == "":
                    print("Join GRU Rewards to redeem an item!")
                    print("1) Convert .png to .gru")
                    print("2) Display .gru image")
                    print("3) Convert .gru to .png")
                    print("4) Join GRU Rewards")
                    ...
                    if reward_count >= 50:
                        import time
                        print("Redirecting you to item in 5...")
                        time.sleep(1)
                        print("Redirecting you to item in 4...")
                        time.sleep(1)
                        print("Redirecting you to item in 3...")
                        time.sleep(1)
                        print("Redirecting you to item in 2...")
                        time.sleep(1)
                        print("Redirecting you to item in 1...")
                        time.sleep(1)
                        webbrowser.open(x)
                        print("1) Convert .png to .gru")
                        print("2) Display .gru image")
                        ...
                        print("Insufficient reward points to redeem this item.")
                        print("1) Convert .png to .gru")
                        print("2) Display .gru image")
                        print("3) Convert .gru to .png")
                        print("4) Join GRU Rewards")
